...
def download_email(save_dir):
    try:
        ...
        eml_file_path = os.path.join(save_dir, 'RawEmail.eml')
...
if __name__ == "__main__":
    ...
    save_directory = os.path.expanduser('./emls')  # This will resolve to /home/username/emails on Linux or C:\Users\username\emails on Windows
